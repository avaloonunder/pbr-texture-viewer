...
def generate_pbr_set(src_path, prefix):
    ...
    # 4. Roughness Map
    roughness_np = 0.80 + (1.0 - height_np) * 0.18
...
generate_pbr_set(
    r"C:\Users\avalo\.gemini\antigravity\brain\4c7c3caf-2809-4355-b399-101999dd647b\dome_stones_nowindow_1787170881337.jpg",
    "TowerClock_DomeBricks_Parallel"
)

# Process With Window
generate_pbr_set(
    r"C:\Users\avalo\.gemini\antigravity\brain\4c7c3caf-2809-4355-b399-101999dd647b\dome_stones_withwindow_1787171188884.jpg",
    "TowerClock_DomeBricks_Window"
)

print("Both dome brick PBR map sets generated successfully!")
